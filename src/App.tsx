          ...
          <div className="app-logo">
            <svg width={82} height={89} viewBox="0 0 82 89" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <g mask="url(#mask1)">
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M48.9193 55.8911C49.125 55.7679 49.2461 55.5415 49.2343 55.302L48.3628 37.6426L39.1264 42.9752L45.8114 56.0508C45.8877 56.2002 46.019 56.3143 46.1776 56.369L47.1244 56.696C47.3057 56.7587 47.5055 56.7379 47.67 56.6393L48.9193 55.8911Z" fill="#DEE1E3" />
                <path opacity="0.4" fillRule="evenodd" clipRule="evenodd" d="M28.8366 47.8013L28.7476 47.8527L30.5638 51.9282C30.6664 52.1584 30.8927 52.3084 31.1446 52.3132L31.6426 52.3226C31.9693 52.3288 32.2498 52.0912 32.2974 51.7678L33.023 46.8334L32.56 47.1007C32.4167 47.1834 32.2626 47.2452 32.1011 47.2813C31.5509 47.4041 30.1547 47.6951 28.8366 47.8013Z" fill="#DEE1E3" />
                <path fillRule="evenodd" clipRule="evenodd" d="M39.2482 43.2134L48.3776 37.9426L48.4769 39.9539L40.956 46.5538L39.2482 43.2134Z" fill="#C5C6CC" />
        ...
        <div className="app-content-wrapper">
          <div className="app-content-flex">
            <div className="content-filter">
              <div className="content-filter-title">Количество пересадок</div>
              <p><input type="radio" id="huey" name="drone" defaultValue="huey" />Все</p>
              <p><input type="radio" id="huey" name="drone" defaultValue="huey" />Без пересадок</p>
              <p><input type="radio" id="huey" name="drone" defaultValue="huey" />1 пересадка</p>
              <p><input type="radio" id="huey" name="drone" defaultValue="huey" />2 пересадки</p>
              <p><input type="radio" id="huey" name="drone" defaultValue="huey" />3 пересадки</p>
            </div>
            <div className="content-right-wrapper">
              <div className="content-tabs">
                <div id="cheap" className="content-tab">Самый дешевый</div>
                <div id="fast" className="content-tab">Самый быстрый</div>
              </div>
              <div className="content-tickets-wrapper">
                <div className="content-ticket-list">
                  <div className="content-ticket">
                    <div className="ticket-header-flex">
                      <div className="ticket-cost">13 400 р</div>
                      <div className="ticket-company">
                        <img src="https://www.s7.ru/images/logotypes/1.png" alt="company-logo" width={110} height={36} />
                      </div>
                    </div>
                    <div className="ticket-info-flex">
                      <div className="ticket-info-period">
                        <p className="info-period-title ticket-info-title">MOW – HKT</p>
                        <p className="info-period-value ticket-info-value">10:45 – 08:00</p>
                      </div>
                      <div className="ticket-info-duration">
                        <p className="info-duration-title ticket-info-title">В пути</p>
                        <p className="info-duration-value ticket-info-value">21ч 15м</p>
                      </div>
                      <div className="ticket-info-transfer">
                        <p className="info-transfer-title ticket-info-title">2 пересадки</p>
                        <p className="info-transfer-value ticket-info-value">HKG, JNB</p>
                      </div>
                    </div>
                    <div className="ticket-info-flex">
                      <div className="ticket-info-period">
